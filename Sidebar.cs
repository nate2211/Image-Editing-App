...
namespace ImageEditingApp
{
    public class Sidebar : Panel
    {
        ...
        private Button rectangleSelectButton;
        ...
        public Sidebar(ImageEditor imageEditor, Overhead imageOverhead)
        {
            this.editor = imageEditor;
            this.overhead = imageOverhead;
            this.Width = 200;
            ...
            rectangleSelectButton = new Button()
            {
                Text = "Rectangle Select",
                Location = new Point(20, 140),
                Size = new Size(150, 30)
            };
            rectangleSelectButton.Click += (s, e) => SetSelectionMode(SelectionMode.Rectangle);

            this.Controls.Add(rectangleSelectButton);
